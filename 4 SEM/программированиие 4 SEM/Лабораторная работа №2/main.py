...
def test_binary_tree(root_value, tree_height):
    ...
    for height in tree_height:
        ...
        print(f"Рекурсивный метод: Высота дерева {height}, Время выполнения: {recursive_time:.6f} сек")
        ...
        print(f"Нерекурсивный метод: Высота дерева {height}, Время выполнения: {non_recursive_time:.6f} сек")
