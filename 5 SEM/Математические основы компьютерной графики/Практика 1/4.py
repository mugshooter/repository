...
while running:
    ...
    # Отображение исходного отрезка (красный) и его середины (маленький красный круг)
    pygame.draw.line(screen, (255, 0, 0), scaled_L[0], scaled_L[1], 2)
    pygame.draw.circle(screen, (255, 0, 0), scaled_mid_L.astype(int), 5)

    # Отображение преобразованного отрезка (синий) и его середины (маленький синий круг)
    pygame.draw.line(screen, (0, 0, 255), scaled_transformed_L[0], scaled_transformed_L[1], 2)
    pygame.draw.circle(screen, (0, 0, 255), scaled_mid_transformed_L.astype(int), 5)

    # Соединение середины исходного и преобразованного отрезков (черный отрезок)
